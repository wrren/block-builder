...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(block_creator)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(block_creator)
ZEND_DECLARE_MODULE_GLOBALS(block_creator)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(block_creator_globals_id, zend_block_creator_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(block_creator_globals_id, zend_block_creator_globals *, error_code )
#else
#define SWIG_ErrorMsg() (block_creator_globals.error_msg)
#define SWIG_ErrorCode() (block_creator_globals.error_code)
#endif
...
static void block_creator_init_globals(zend_block_creator_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void block_creator_destroy_globals(zend_block_creator_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_block_creator_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_block_creator_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "block_creator"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
ZEND_NAMED_FUNCTION(_wrap_create_block) {
  ...
  HashTable *arr_hash = Z_ARRVAL_P( *args[7] );
  zval **arr_value;
  char** images = malloc( arg9 * sizeof( char* ) );
  int i = 0;
  for(  zend_hash_internal_pointer_reset( arr_hash );
        zend_hash_get_current_data( arr_hash, (void **) &arr_value ) == SUCCESS;
        zend_hash_move_forward( arr_hash ), i++ )
  {
      images[i] = Z_STRVAL_PP( arr_value );
  }
  ...
  result = (int)create_block((char const *)arg1,(char const *)arg2,(char const *)arg3,arg4,arg5,arg6,arg7,images,arg9,arg10);
  {
...
static zend_function_entry block_creator_functions[] = {
 SWIG_ZEND_NAMED_FE(create_block,_wrap_create_block,NULL)
 SWIG_ZEND_NAMED_FE(swig_block_creator_alter_newobject,_wrap_swig_block_creator_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_block_creator_get_newobject,_wrap_swig_block_creator_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry block_creator_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"block_creator",
    block_creator_functions,
    PHP_MINIT(block_creator),
    PHP_MSHUTDOWN(block_creator),
    PHP_RINIT(block_creator),
    PHP_RSHUTDOWN(block_creator),
    PHP_MINFO(block_creator),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &block_creator_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &block_creator_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(block_creator)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(block_creator, block_creator_init_globals, block_creator_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(block_creator_globals_id);
#endif
    return SUCCESS;
}
